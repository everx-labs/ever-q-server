...
function createResolvers(data: QBlockchainData) {
    return {
        ...
        ConfigP8: {
            ...
            capabilities_flags: createFlagsResolver("capabilities", { CapNone: 0, CapIhrEnabled: 1, CapCreateStatsEnabled: 2, CapBounceMsgBody: 4, CapReportVersion: 8, CapSplitMergeTransactions: 16, CapShortDequeue: 32, CapMbppEnabled: 64, CapFastStorageStat: 128, CapInitCodeHash: 256, CapOffHypercube: 512, CapMyCode: 1024, CapSetLibCode: 2048, CapFixTupleIndexBug: 4096, CapRemp: 8192, CapDElections: 16384, CapFullBodyInBounced: 65536, CapStorageFeeToTvm: 131072, CapCopyleft: 262144, CapIndexAccounts: 524288, CapDiff: 1048576, CapsTvmBugfixes2022: 2097152, CapWorkchains: 4194304, CapStcontNewFormat: 8388608, CapFastStorageStatBugfix: 16777216, CapResolveMerkleCell: 33554432, CapSignatureWithId: 67108864, CapBounceAfterFailedAction: 134217728, CapGroth16: 268435456, CapFeeInGasUnits: 536870912, CapBigCells: 1073741824, CapSuspendedList: 2147483648, CapFastFinality: 4294967296, CapTvmV19: 8589934592, CapSmft: 17179869184, CapNoSplitOutQueue: 34359738368, CapUndeletableAccounts: 68719476736, CapTvmV20: 137438953472, CapDuePaymentFix: 274877906944, CapCommonMessage: 549755813888, CapPipeline: 1099511627776 }),
        },
        ConfigP14: {
        ...
        BlockMaster: {
            max_shard_gen_utime_string(parent: { max_shard_gen_utime: number }) {
                return unixSecondsToString(parent.max_shard_gen_utime);
            },
            min_shard_gen_utime_string(parent: { min_shard_gen_utime: number }) {
...
scalarFields.set("accounts.prev_code_hash", { type: "string", path: "doc.prev_code_hash" });
...
scalarFields.set("transactions.code_hash", { type: "string", path: "doc.code_hash" });
...
scalarFields.set("transactions.master_seq_no", { type: "number", path: "doc.master_seq_no" });
...
scalarFields.set("transactions.trace.cmd_code_cell_hash", { type: "string", path: "doc.trace[*].cmd_code_cell_hash" });
scalarFields.set("transactions.trace.cmd_code_hex", { type: "string", path: "doc.trace[*].cmd_code_hex" });
scalarFields.set("transactions.trace.cmd_code_offset", { type: "number", path: "doc.trace[*].cmd_code_offset" });
scalarFields.set("transactions.trace.cmd_code_rem_bits", { type: "number", path: "doc.trace[*].cmd_code_rem_bits" });
scalarFields.set("transactions.trace.cmd_str", { type: "string", path: "doc.trace[*].cmd_str" });
scalarFields.set("transactions.trace.gas_cmd", { type: "string", path: "doc.trace[*].gas_cmd" });
scalarFields.set("transactions.trace.gas_used", { type: "string", path: "doc.trace[*].gas_used" });
scalarFields.set("transactions.trace.info_type", { type: "string", path: "doc.trace[*].info_type" });
scalarFields.set("transactions.trace.stack", { type: "string", path: "doc.trace[*].stack[**]" });
scalarFields.set("transactions.trace.step", { type: "number", path: "doc.trace[*].step" });
...
scalarFields.set("messages.dst_chain_order", { type: "string", path: "doc.dst_chain_order" });
scalarFields.set("messages.dst_code_hash", { type: "string", path: "doc.dst_code_hash" });
...
scalarFields.set("messages.master_seq_no", { type: "number", path: "doc.master_seq_no" });
...
scalarFields.set("messages.src_chain_order", { type: "string", path: "doc.src_chain_order" });
scalarFields.set("messages.src_code_hash", { type: "string", path: "doc.src_code_hash" });
...
scalarFields.set("blocks.master.config.p30.delections_step", { type: "number", path: "doc.master.config.p30.delections_step" });
scalarFields.set("blocks.master.config.p30.staker_init_code_hash", { type: "string", path: "doc.master.config.p30.staker_init_code_hash" });
scalarFields.set("blocks.master.config.p30.validator_init_code_hash", { type: "string", path: "doc.master.config.p30.validator_init_code_hash" });
...
scalarFields.set("blocks.master.config.p39.map_key", { type: "string", path: "doc.master.config.p39[*].map_key" });
...
scalarFields.set("blocks.master.config.p40.collations_score_weight", { type: "number", path: "doc.master.config.p40.collations_score_weight" });
scalarFields.set("blocks.master.config.p40.min_samples_count", { type: "number", path: "doc.master.config.p40.min_samples_count" });
scalarFields.set("blocks.master.config.p40.min_slashing_protection_score", { type: "number", path: "doc.master.config.p40.min_slashing_protection_score" });
scalarFields.set("blocks.master.config.p40.resend_mc_blocks_count", { type: "number", path: "doc.master.config.p40.resend_mc_blocks_count" });
scalarFields.set("blocks.master.config.p40.signing_score_weight", { type: "number", path: "doc.master.config.p40.signing_score_weight" });
scalarFields.set("blocks.master.config.p40.slashing_period_mc_blocks_count", { type: "number", path: "doc.master.config.p40.slashing_period_mc_blocks_count" });
scalarFields.set("blocks.master.config.p40.z_param_denominator", { type: "number", path: "doc.master.config.p40.z_param_denominator" });
scalarFields.set("blocks.master.config.p40.z_param_numerator", { type: "number", path: "doc.master.config.p40.z_param_numerator" });
scalarFields.set("blocks.master.config.p42.payouts.license_type", { type: "number", path: "doc.master.config.p42.payouts[*].license_type" });
scalarFields.set("blocks.master.config.p42.payouts.payout_percent", { type: "number", path: "doc.master.config.p42.payouts[*].payout_percent" });
scalarFields.set("blocks.master.config.p42.threshold", { type: "uint1024", path: "doc.master.config.p42.threshold" });
scalarFields.set("blocks.master.config.p44", { type: "string", path: "doc.master.config.p44[*]" });
...
scalarFields.set("blocks.master_seq_no", { type: "number", path: "doc.master_seq_no" });
...
scalarFields.set("zerostates.accounts.prev_code_hash", { type: "string", path: "doc.accounts[*].prev_code_hash" });
...
scalarFields.set("zerostates.master.config.p30.delections_step", { type: "number", path: "doc.master.config.p30.delections_step" });
scalarFields.set("zerostates.master.config.p30.staker_init_code_hash", { type: "string", path: "doc.master.config.p30.staker_init_code_hash" });
scalarFields.set("zerostates.master.config.p30.validator_init_code_hash", { type: "string", path: "doc.master.config.p30.validator_init_code_hash" });
...
scalarFields.set("zerostates.master.config.p39.map_key", { type: "string", path: "doc.master.config.p39[*].map_key" });
...
scalarFields.set("zerostates.master.config.p40.collations_score_weight", { type: "number", path: "doc.master.config.p40.collations_score_weight" });
scalarFields.set("zerostates.master.config.p40.min_samples_count", { type: "number", path: "doc.master.config.p40.min_samples_count" });
scalarFields.set("zerostates.master.config.p40.min_slashing_protection_score", { type: "number", path: "doc.master.config.p40.min_slashing_protection_score" });
scalarFields.set("zerostates.master.config.p40.resend_mc_blocks_count", { type: "number", path: "doc.master.config.p40.resend_mc_blocks_count" });
scalarFields.set("zerostates.master.config.p40.signing_score_weight", { type: "number", path: "doc.master.config.p40.signing_score_weight" });
scalarFields.set("zerostates.master.config.p40.slashing_period_mc_blocks_count", { type: "number", path: "doc.master.config.p40.slashing_period_mc_blocks_count" });
scalarFields.set("zerostates.master.config.p40.z_param_denominator", { type: "number", path: "doc.master.config.p40.z_param_denominator" });
scalarFields.set("zerostates.master.config.p40.z_param_numerator", { type: "number", path: "doc.master.config.p40.z_param_numerator" });
scalarFields.set("zerostates.master.config.p42.payouts.license_type", { type: "number", path: "doc.master.config.p42.payouts[*].license_type" });
scalarFields.set("zerostates.master.config.p42.payouts.payout_percent", { type: "number", path: "doc.master.config.p42.payouts[*].payout_percent" });
scalarFields.set("zerostates.master.config.p42.threshold", { type: "uint1024", path: "doc.master.config.p42.threshold" });
scalarFields.set("zerostates.master.config.p44", { type: "string", path: "doc.master.config.p44[*]" });
