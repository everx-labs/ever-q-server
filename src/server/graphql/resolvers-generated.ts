...
function createResolvers(data) {
    return {
        ...
        BlockMasterShardHashesDescr: {
            ...
            gen_utime_string(parent: any, _args: any) {
        ...
        ConfigP18: {
            ...
            utime_since_string(parent: any, _args: any) {
        ...
        ValidatorSet: {
            ...
            utime_until_string(parent: any, _args: any) {
        ...
        BlockSignatures: {
            ...
            block(parent: any, args: any, context: any) {
        ...
        Block: {
            ...
            signatures(parent: any, args: any, context: any) {
        ...
        Transaction: {
            ...
            account(parent: any, args: any, context: any) {
            ...
            in_message(parent: any, args: any, context: any) {
                if (args.when && !Transaction.test(null, parent, args.when)) {
                    return null;
                }
                return context.data.messages.waitForDoc(parent.in_msg, "_key", args, context);
            },
            out_messages(parent: any, args: any, context: any) {
                if (args.when && !Transaction.test(null, parent, args.when)) {
                    return null;
                }
            ...
            now_string(parent: any, _args: any) {
        ...
        Message: {
            ...
            dst_account(parent: any, args: any, context: any) {
            ...
            dst_transaction(parent: any, args: any, context: any) {
                if (!(parent.msg_type !== 2)) {
                    return null;
                }
                if (args.when && !Message.test(null, parent, args.when)) {
            ...
            src_account(parent: any, args: any, context: any) {
            ...
            src_transaction(parent: any, args: any, context: any) {
            ...
            created_at_string(parent: any, _args: any) {
