...
export const resolvers: Resolvers<QRequestContext> = {
    BlockchainMessage: {
        ...
        created_lt: (parent, args) => resolveBigUInt(1, parent.created_lt, args as BigIntArgs),
        fwd_fee: (parent, args) => resolveBigUInt(2, parent.fwd_fee, args as BigIntArgs),
        ...
        msg_type_name: parent => {
            switch(parent.msg_type) {
                ...
                case 1: return MessageTypeEnum.ExtIn;
                case 2: return MessageTypeEnum.ExtOut;
                default: return null;
            }
        },
        status_name: parent => {
            switch(parent.msg_type) {
                ...
                case 3: return MessageProcessingStatusEnum.Preliminary;
                case 4: return MessageProcessingStatusEnum.Proposed;
                case 5: return MessageProcessingStatusEnum.Finalized;
                case 6: return MessageProcessingStatusEnum.Refused;
                case 7: return MessageProcessingStatusEnum.Transiting;
                default: return null;
            }
        },
    },
