...
const Message: TypeDef = {
    ...
    src_workchain_id: i32(), // TODO: add doc
    dst_workchain_id: i32(), // TODO: add doc
...
const shardDescr = (doc?: string): TypeDef => withDoc({
    ...
    gen_utime: u32(docs.shardDescr.gen_utime),
...
const Block: TypeDef = {
    ...
    gen_utime: i32(docs.block.gen_utime),
