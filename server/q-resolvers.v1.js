...
module.exports = {
    ...
    IntermediateAddress,
    ExtBlkRef,
    MsgAddressIntAddrStdAnycast,
    MsgAddressIntAddrStd,
    MsgAddressIntAddrVarAnycast,
    MsgAddressIntAddrVar,
    MsgAddressInt,
    TickTock,
    StorageUsedShort,
    SplitMergeInfo,
    MsgAddressExtAddrExtern,
    MsgAddressExt,
    MessageHeaderIntMsgInfo,
    MessageHeaderExtInMsgInfo,
    ...
    Block,
    AccountStorageStat,
    AccountStorageStateAccountActive,
    AccountStorageState,
    AccountStorage,
    Account,
    ...
    TrBouncePhaseOk,
    TrBouncePhase,
    TransactionDescriptionOrdinary,
